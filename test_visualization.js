...
function runTests() {
    ...
    allPassed &= testFile('create_embedded_version.js', 'Embedded Version Creator');
    ...
    allPassed &= testHtmlFile('brotato_network_embedded.html', 'Embedded Visualization', [
        'EMBEDDED_NETWORK_DATA',
        'd3.forceSimulation',
    ...
    if (allPassed) {
        ...
        console.log('\n🚀 Quick Start Options:');
        console.log('   1. Open brotato_network_embedded.html directly');
        console.log('   2. Run: ./start_server.sh (Unix) or start_server.bat (Windows)');
        console.log('   3. Run: python -m http.server 8000');
    } else {
        console.log('❌ Some tests failed. Please check the issues above.');
        console.log('\n🔧 To fix missing files, run:');
        console.log('   - node process_data.js (for network data)');
        console.log('   - node create_embedded_version.js (for embedded version)');
    }
